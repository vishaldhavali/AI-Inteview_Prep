        ...
        <div className="space-y-4">
          <div className="flex justify-center">
            {!isRecording ? (
              ...
              <Button onClick={handleStopRecording} size="lg" variant="destructive" className="rounded-full h-16 w-16">
          ...
          <div className="text-center">
            {isRecording ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">Your answer will be transcribed in real-time</p>
              </div>
            )}
          </div>
          ...
          <div className="text-xs text-gray-500 text-center">Make sure to allow microphone access when prompted</div>
        </div>
      </CardContent>
    </Card>
  )
